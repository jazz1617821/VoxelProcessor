...
public:
    ...
    void retranslateUi(QWidget *VoxelizeWidget)
    {
        ...
        lb_solidModel->setText(QApplication::translate("VoxelizeWidget", "Solid Model", nullptr));
        lb_solidModelSpace->setText(QString());
        ckb_solidModel->setText(QApplication::translate("VoxelizeWidget", "Enabel", nullptr));
    } // retranslateUi
