/****************************************************************************
** Meta object code from reading C++ file 'slicewidget.hpp'
**
...
#error "The header file 'slicewidget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 9), // "sliceDone"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7), // "confirm"
QT_MOC_LITERAL(4, 31, 6) // "cancel"

    },
    "SliceWidget\0sliceDone\0\0confirm\0cancel"
};
...
void SliceWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SliceWidget::sliceDone)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SliceWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SliceWidget.data,
      qt_meta_data_SliceWidget,  qt_static_metacall, nullptr, nullptr}
};
